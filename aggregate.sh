...
- 개인이 아니라 기업·제품·조직의 공식 계정/회사 페이지(예: OpenAI, Micron, Sakana AI,
  ...
  '- (<플랫폼>) <조직명> — <내용>' 형식으로 나열하라. 이 항목들은 커버리지의 '인물' 수에
  넣지 않는다. (개인 계정은 추적 여부와 무관하게 인물로 다룬다.)
...
(인물 섹션들 다음에 "조용함:" 한 줄로 오늘 조용했던 주요 추적 대상 이름만 나열. 그 외 총평 금지.)
그리고 맨 끝에, 기업·조직 공식 계정이 올린 유의미한 항목이 있으면 "## 기업/조직 소식" 한 섹션으로 모아 둔다.
